...
#if SMC_DEBUG
	qprintf( "SMC37c669 Super I/O Controller found @ %x\n", SMC_base );
#endif
...
#if SMC_DEBUG
	qprintf( "No SMC37c669 Super I/O Controller found\n" );
#endif
    }
}
...
{                                          
	...
	setup_io( );
/*
** Clear the soft reset register
*/
	outtig( NULL, 0xE00004, 0 );
    } 
...
*/
	out_flash( NULL, 0xC00001, 1 );
	if ( in_flash( NULL, 0xC00001 ) != 1 )
	    qprintf( "Flash ROM writes are disabled\n" ); 
    }
}    
    
/*+  
 ...
 * OVERVIEW:
 *
 *	Perform hardware reset on the PC264
 *
 * FORM OF CALL:
 *
 *	reset_hardware (log); 
...
/*
** Disable PCI Target Windows first.
*/
        WriteTsunamiCSR( PCHIP0_WSBA0, 0 );
        WriteTsunamiCSR( PCHIP0_WSBA1, 0 );
        WriteTsunamiCSR( PCHIP0_WSBA2, 0 );
        WriteTsunamiCSR( PCHIP0_WSBA3, 0 );

        WriteTsunamiCSR( PCHIP1_WSBA0, 0 );
        WriteTsunamiCSR( PCHIP1_WSBA1, 0 );
        WriteTsunamiCSR( PCHIP1_WSBA2, 0 );
        WriteTsunamiCSR( PCHIP1_WSBA3, 0 );
/* 
** Wait for all transactions to complete. 
*/
        krn$_micro_delay( 500000 );
/*
** Reset the PCI bus...
*/
	WriteTsunamiCSR( PCHIP0_SPRST, 0 );
	WriteTsunamiCSR( PCHIP1_SPRST, 0 );
