...
#define _AIC78XX_H_

/* $Header: /home/CVSROOT/sw/srmconsole/5.8/SRC/AIC78XX_DEF.H,v 1.2 2001/01/13 05:23:34 chris Exp $ */
/***************************************************************************
*                                                                          *
...
typedef long            HIM_SINT8;    /* signed   int  - min of   8       */
typedef unsigned long   HIM_UINT8;    /* unsigned int  - min of   8       */
typedef char            HIM_SEXACT8;  /* signed   byte - exactly  8       */
typedef unsigned char   HIM_UEXACT8;  /* unsigned byte - exactly  8       */
