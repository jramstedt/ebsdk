 ...
 *
-*/
int du_read( struct FILE *fp, int ilen, int inum, unsigned char *c )
    {
    int i;
    int t;
...
int du_read_sub( struct FILE *fp, int ilen, int inum, unsigned char *c )
    {
    int len;
    int lbn;
    int t;
 ...
 *
-*/
int du_write( struct FILE *fp, int ilen, int inum, unsigned char *c )
    {
    int i;
    int t;
...
int du_write_sub( struct FILE *fp, int ilen, int inum, unsigned char *c )
    {
    int len;
    int lbn;
    int t;
 ...
 *
-*/
int du_open( struct FILE *fp, char *info, char *next, char *mode )
    {
    int t;
    struct ub *ub;
    struct cb *cb;
	...
	if( t == msg_success )
	    {
	    fp->misc = rsp;
	    fp->rap = malloc_noown( sizeof( struct RAB ) );
	    fp->rap->alloc = 512;
	    fp->rap->buf = malloc_noown( 512 );
	    fp->rap->inx = -1;
	    fp->rap->outx = 0;
	    }
	else
 ...
 *
-*/
int mu_read( struct FILE *fp, int ilen, int inum, unsigned char *c )
    {
    int len;
    int t;
    struct INODE *inode;
 ...
 *
-*/
int mu_write( struct FILE *fp, int ilen, int inum, unsigned char *c )
    {
    int len;
    int t;
    struct INODE *inode;
 ...
 *
-*/
int mu_open( struct FILE *fp, char *info, char *next, char *mode )
    {
    int t;
    struct ub *ub;
    struct cb *cb;
...
int mscp_delete( struct INODE *inode )
    {
    struct ub *ub;
...
int mscp_unit_okay( struct FILE *fp, int flag )
    {
    int i;
    int j;
    struct INODE *inode;
 ...
 *
-*/
void mscp_new_node( struct mscp_sb *sb )
    {
    char name[20];
    int mscp_unit( );
 ...
 *
-*/
void mscp_unit( struct mscp_sb *sb, struct DDB *driver )
    {
 ...
 *
-*/
void mscp_appl_msg_input( struct cb *cb, struct mscp_generic_rsp *p, int len )
    {
    struct rsp *rsp;
 ...
 *
-*/
void mscp_connection_error( struct cb *cb )
    {
 ...
 *
-*/
void mscp_keepalive( struct cb *cb )
    {
 ...
 *
-*/
void mscp_get_command_cmd( struct cb *cb, struct rsp *rsp )
    {
 ...
 *
-*/
void mscp_set_cont_cmd( struct cb *cb, struct rsp *rsp )
    {
 ...
 *
-*/
int mscp_available_cmd( struct cb *cb, struct rsp *rsp, struct ub *ub )
    {
 ...
 *
-*/
int mscp_online_cmd( struct cb *cb, struct rsp *rsp, struct ub *ub )
    {
 ...
 *
-*/
int mscp_read_cmd( struct cb *cb, struct rsp *rsp, struct ub *ub,
 ...
 *
-*/
int mscp_write_cmd( struct cb *cb, struct rsp *rsp, struct ub *ub,
	unsigned char *buffer, int *size, int lbn )
    {
    unsigned long int map_info[4];
 ...
 *
-*/
void mscp_poll_units( struct cb *cb, struct rsp *rsp )
    {
    int t;
    struct mscp_get_unit_cmd *p;
 ...
 *
-*/
void mscp_new_unit( struct cb *cb, struct mscp_get_unit_rsp *q )
    {
    char name[32];
    char c;
    char *np;
