...
/*
** Am29F800BTx2 Layout  x2 means 2 back to back.
**
**    Sector   Start     End     Sector
**    Number   Addr      Addr     Size
**    ------  -------   -------  ------
**       0    0x000000  0x0ffff  64 kB
**       1    0x010000  0x1ffff  64 kB
**       2    0x020000  0x2ffff  64 kB
**       3    0x030000  0x3ffff  64 kB
**       4    0x040000  0x4ffff  64 kB
**       5    0x050000  0x5ffff  64 kB
**       6    0x060000  0x6ffff  64 kB
**       7    0x070000  0x7ffff  64 kB
**       8    0x080000  0x8ffff  64 kB
**       9    0x090000  0x9ffff  64 kB
**      10    0x0a0000  0xaffff  64 kB
**      11    0x0b0000  0xbffff  64 kB
**      12    0x0c0000  0xcffff  64 kB
**      13    0x0d0000  0xdffff  64 kB
**      14    0x0e0000  0xeffff  64 kB
**      15    0x0f0000  0xf7fff  32 kB
**      16    0x0f8000  0xf9fff   8 kB
**      17    0x0fa000  0xfbfff   8 kB
**      18    0x0fc000  0xfffff  16 kB
**      19    0x100000  0x0ffff  64 kB
**      20    0x110000  0x1ffff  64 kB
**      21    0x120000  0x2ffff  64 kB
**      22    0x130000  0x3ffff  64 kB
**      23    0x140000  0x4ffff  64 kB
**      24    0x150000  0x5ffff  64 kB
**      25    0x160000  0x6ffff  64 kB
**      26    0x170000  0x7ffff  64 kB
**      27    0x180000  0x8ffff  64 kB
**      28    0x190000  0x9ffff  64 kB
**      29    0x1a0000  0xaffff  64 kB
**      30    0x1b0000  0xbffff  64 kB
**      31    0x1c0000  0xcffff  64 kB
**      32    0x1d0000  0xdffff  64 kB
**      33    0x1e0000  0xeffff  64 kB
**      34    0x1f0000  0xf7fff  32 kB
**      35    0x1f8000  0xf9fff   8 kB
**      36    0x1fa000  0xfbfff   8 kB
**      37    0x1fc000  0xfffff  16 kB
*/
static AMD_SECTOR_INFORMATION Am29F800BTx2_layout[] = {
  {0x000000, 0x10000},  /* Sector 0	*/ 
  {0x010000, 0x10000},  /* Sector 1	*/ 
  {0x020000, 0x10000},  /* Sector 2	*/ 
  {0x030000, 0x10000},  /* Sector 3	*/ 
  ...
  {0x0d0000, 0x10000},  /* Sector 13	*/ 
  {0x0e0000, 0x10000},  /* Sector 14	*/ 
  {0x0f0000, 0x08000},  /* Sector 15	*/ 
  {0x0f8000, 0x02000},  /* Sector 16	*/ 
  {0x0fa000, 0x02000},  /* Sector 17	*/ 
  {0x0fc000, 0x04000},  /* Sector 18	*/ 
  {0x100000, 0x10000},  /* Sector 19	*/ 
  {0x110000, 0x10000},  /* Sector 20	*/ 
  {0x120000, 0x10000},  /* Sector 21	*/ 
  {0x130000, 0x10000},  /* Sector 22	*/ 
  {0x140000, 0x10000},  /* Sector 23	*/ 
  {0x150000, 0x10000},  /* Sector 24	*/ 
  {0x160000, 0x10000},  /* Sector 25	*/ 
  {0x170000, 0x10000},  /* Sector 26	*/ 
  {0x180000, 0x10000},  /* Sector 27	*/ 
  {0x190000, 0x10000},  /* Sector 28	*/ 
  {0x1a0000, 0x10000},  /* Sector 29	*/ 
  {0x1b0000, 0x10000},  /* Sector 30	*/ 
  {0x1c0000, 0x10000},  /* Sector 31	*/ 
  {0x1d0000, 0x10000},  /* Sector 32	*/ 
  {0x1e0000, 0x10000},  /* Sector 33	*/ 
  {0x1f0000, 0x08000},  /* Sector 34 	*/ 
  {0x1f8000, 0x02000},  /* Sector 35 	*/ 
  {0x1fa000, 0x02000},  /* Sector 36	*/ 
  {0x1fc000, 0x04000},  /* Sector 37	*/ 
  {0x000000, 0x00000}
};

/*
** Am29F800BTx2 FLASH_DEVICE structure   x2 means 2 back to back.
*/
static AMD_FLASH_DEVICE Am29F800BTx2_device_info = {
  "AMD Am29F800BTx2",   /* Device Name			*/
  0xd6,                 /* Device Id			*/
  0x100000,             /* Device Size (1 MB)	*/
  0xff,                 /* Erased data			*/
  0x30,                 /* SectorEraseConfirm	*/
  0x02,                 /* DeviceIdOffset		*/
  Am29F800BTx2_layout,  /* Device Layout		*/
  &Am29LV800_commands   /* Commands			*/
};
...
*/
	...
	id = rb( 0 );
	if ( ( id == AMD_MANUFACTURER_ID ) || ( id == FUJITSU_MANUFACTURER_ID ) ) {
/*
...
unsigned int flash_sector_size(unsigned int offset)
{
	return(driver_info.fdp->block_size_function(offset));
}
