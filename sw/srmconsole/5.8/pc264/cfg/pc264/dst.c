...
struct DST {
  ...
  {lfu_pc264_init,	"lfu_pc264",	7},
  {lfu_kzpsa_init,	"lfu_kzpsa",	7},
  {lfu_defpa_defea_init,	"lfu_defpa_defea",	7},
  {lfu_cipca_init,	"lfu_cipca",	7},
  {lfu_mc2_init,	"lfu_mc2",	7},
};
