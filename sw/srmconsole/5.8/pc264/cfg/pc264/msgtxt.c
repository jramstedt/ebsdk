...
/* msg_exdep_badaddr is referenced and not defined */
...
/* msg_mem_ex_done is referenced and not defined */
...
/* msg_selected is referenced and not defined */
/* msg_succes is referenced and not defined */
/* msg_to_targ is referenced and not defined */
/* msg_trace is referenced and not defined */
/* msg_unichck is referenced and not defined */
/* msg_write_failure is referenced and not defined */
/* msg_write_success is referenced and not defined */
