...
tinosa_nbridge_depend	= -
	...
	cp$src:pb_def.h,-
	cp$src:common.h,-
	cp$src:tinosa_nbridge.h,-
	cp$src:m1543c_sbridge.h,-
	cp$src:goby.h,-
	cp$src:nt_types.h,-

memconfig_tinosa_depend	= -
	cp$src:platform.h,-
	cp$src:kernel_def.h,-
	cp$src:msg_def.h,-
	cp$src:stddef.h,-
