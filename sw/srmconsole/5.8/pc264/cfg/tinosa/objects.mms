! TINOSA Target-specific dependencies
i_objects = -
...
objects = $(i_objects), -
	...
	cp$obj:xlate.obj,-
	cp$obj:tinosa.obj,-
	cp$obj:tinosa_init.obj,-
	cp$obj:goby_io.obj,-
	cp$obj:tinosa_io.obj,-
	cp$obj:tinosa_mcheck.obj,-
	cp$obj:tinosa_nbridge.obj,-
	cp$obj:memconfig_tinosa.obj,-
	cp$obj:show_config_tinosa.obj,-
	cp$obj:amdflash_support.obj,-
	cp$obj:m1543c_sbridge.obj,-
	cp$obj:m1543c_iic.obj,-
	cp$obj:m5229_ide.obj,-
	cp$obj:api_debug.obj,-
	cp$obj:tinosa_info.obj,-
...
cp$obj:grp_base.obj : -
	...
	cp$src:tinosa.c, $(tinosa_depend),-
	cp$src:tinosa_init.c, $(tinosa_init_depend),-
	cp$src:goby_io.c, $(goby_io_depend),-
	cp$src:tinosa_io.c, $(tinosa_io_depend),-
	cp$src:tinosa_mcheck.c, $(tinosa_mcheck_depend),-
	cp$src:memconfig_tinosa.c, $(memconfig_tinosa_depend),-
	cp$src:show_config_tinosa.c, $(show_config_tinosa_depend),-
 ...
 $(cc) $(cdefs) $(cquals) $(copt) $(list) -
	...
	+tinosa+tinosa_init+goby_io+tinosa_io+tinosa_mcheck+memconfig_tinosa+show_config_tinosa+amdflash_support+m1543c_sbridge+m1543c_iic+m5229_ide+decode_alpha+diag_support+diag_evs+secure+symbols+memtest+memtest_gray_lw+memtest_march-
	+memtest_random+memtest_victim+nettest+lfu_support_apc+dup
	! Group "base" command length was ~649
...
cp$obj:grp_command.obj : -
	...
	cp$src:tinosa_nbridge.c, $(tinosa_nbridge_depend),-
	cp$src:api_debug.c, $(api_debug_depend),-
	cp$src:tinosa_info.c, $(tinosa_info_depend),-
	...
	cp$src:galaxy_tinosa.c, $(galaxy_tinosa_depend),-
 ...
 $(cc) $(cdefs) $(cquals) $(copt) $(list) -
	...
	cp$src:blex.c+bshell+bshell_cmd+boot+builtins+build_fru+date_cmd+exdep+iobq_cmd+isacfg+isp1020_edit+readline+run_cmd+show_hwrpb+show_map+setshow+startstop+tr+uptime+xlate+tinosa_nbridge+api_debug+tinosa_info+dp264_fru+allocfree+bpt+cat+check-
	+chmod+cmp+element+echo+edit+eval+exer+find_field+grep+galaxy+galaxy_tinosa+galaxy_config_tree+hd+help+line+login_cmd+ls+more+net+prcache+prcache_pci+ps+rm+sem_cmd+sleep+sort+sound+truefalse+validate+wc+lfu
	! Group "command" command length was ~572
...
cp$obj:grp_driver.obj : -
	...
	cp$src:lfu_tinosa_driver.c, $(lfu_tinosa_driver_depend),-
 ...
 $(cc) $(cdefs) $(cquals) $(copt) $(list) -
	...
	+i2oexec+i2omsg+i2outil+i2o_bsa+i2o_bsa_osm+i2o_scsi_osm+iso9660_driver+aic78xx_driver+aic78xx_him_hwm+aic78xx_him_rsm+aic78xx_him_xlm+bios_disk_driver+lfu_tinosa_driver+lfu_kzpsa_driver+lfu_defpa_defea_driver+lfu_cipca_driver+lfu_mc2_driver
	! Warning: Group "driver" command length was ~1079
!
! Group "data" (1 files)
!
cp$obj:grp_data.obj : -
...
slis = -
	...
	cp$lis:xlate.slis,-
	cp$lis:tinosa.slis,-
	cp$lis:tinosa_init.slis,-
	cp$lis:goby_io.slis,-
	cp$lis:tinosa_io.slis,-
	cp$lis:tinosa_mcheck.slis,-
	cp$lis:tinosa_nbridge.slis,-
	cp$lis:pc264_util.slis,-
	cp$lis:memconfig_tinosa.slis,-
	cp$lis:show_config_tinosa.slis,-
	cp$lis:amdflash_support.slis,-
	cp$lis:m1543c_sbridge.slis,-
	cp$lis:m1543c_iic.slis,-
	cp$lis:m5229_ide.slis,-
	cp$lis:api_debug.slis,-
	cp$lis:tinosa_info.slis,-
...
cp$obj:encap_pwrup.obj : cp$src:pwrup_tinosa
	mcr cp$kits:[encapsulate.new]encapsulate cp$src:pwrup_tinosa cp$src:encap_pwrup.mar encap_pwrup -script
...
cp$obj:encap_mfgtest.obj : cp$src:tinosa_mfgtest
	mcr cp$kits:[encapsulate.new]encapsulate cp$src:tinosa_mfgtest cp$src:encap_mfgtest.mar encap_mfgtest -script
...
cp$obj:tinosa.obj : cp$src:tinosa.c, $(tinosa_depend)
cp$obj:tinosa_init.obj : cp$src:tinosa_init.c, $(tinosa_init_depend)
cp$obj:goby_io.obj : cp$src:goby_io.c, $(goby_io_depend)
cp$obj:tinosa_io.obj : cp$src:tinosa_io.c, $(tinosa_io_depend)
cp$obj:tinosa_mcheck.obj : cp$src:tinosa_mcheck.c, $(tinosa_mcheck_depend)
cp$obj:tinosa_nbridge.obj : cp$src:tinosa_nbridge.c, $(tinosa_nbridge_depend)
cp$obj:memconfig_tinosa.obj : cp$src:memconfig_tinosa.c, $(memconfig_tinosa_depend)
cp$obj:show_config_tinosa.obj : cp$src:show_config_tinosa.c, $(show_config_tinosa_depend)
...
cp$obj:tinosa_info.obj : cp$src:tinosa_info.c, $(tinosa_info_depend)
...
cp$obj:galaxy_tinosa.obj : cp$src:galaxy_tinosa.c, $(galaxy_tinosa_depend)
...
cp$obj:lfu_tinosa_driver.obj : cp$src:lfu_tinosa_driver.c, $(lfu_tinosa_driver_depend)
