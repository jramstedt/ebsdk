...
char topic_036 [] = { "show power" };
char  text_036 [] = { "Display power supply and fan status." };
char   syn_036 [] = { "show power " };
...
char topic_086 [] = { "ewrk3_config" };
char  text_086 [] = { "Change the DE205 configuration, find addresses of modules." };
char   syn_086 [] = { "ewrk3_config ([-curaddr <addr#>][-ioaddr <hex value>][-irq <3,5,9,10,15>] \n\
\t               [-fbus <0,1>][-ena16 <0,1>][-memaddr <hex>] \n\
\t               [-bufsize <2,32,64>][-swflag <hexvalue>] \n\
\t               [-netmgt <hex value>][-zws <0,1>][-ra<0,1>][-wb<0,1>] \n\
\t               [-default]) " };

char topic_087 [] = { "wwidmgr" };
char  text_087 [] = { "Manage the wwid registration." };
char   syn_087 [] = { "wwidmgr [-quickset {-item <#>], -udid <#> } ] \n\
...
char topic_088 [] = { "mc_diag" };
char  text_088 [] = { "Memory Channel Read/Write & Loopback diagnostic." };
char   syn_088 [] = { "mc_diag [-d] " };

char topic_089 [] = { "mc_cable" };
char  text_089 [] = { "Memory Channel cable check diagnostic." };
char   syn_089 [] = { "mc_cable " };

char topic_090 [] = { "memexer" };
char  text_090 [] = { "Invoke Gray code memory exerciser." };
char   syn_090 [] = { "memexer [<number>] " };

char topic_091 [] = { "sys_exer" };
char  text_091 [] = { "exercise all the devices in the system concurrently." };
char   syn_091 [] = { "sys_exer [-lb] " };

char topic_092 [] = { "show_status" };
char  text_092 [] = { "Show the status of any currently executing diagnostics." };
char   syn_092 [] = { "show_status " };

char topic_093 [] = { "kill_diags" };
char  text_093 [] = { "Kill all currently executing diagnostic processes." };
char   syn_093 [] = { "kill_diags " };

char topic_094 [] = { "test" };
char  text_094 [] = { "Test the system." };
char   syn_094 [] = { "test [-lb] [-t <time>] \n\
\t               \n\
\t               COMMAND ARGUMENT(S): " };

char topic_095 [] = { "save_nvram" };
char  text_095 [] = { "Save NVRAM data in EEROM/TOY to a floppy file." };
char   syn_095 [] = { "save_nvram {all,arc,srm,toy} " };

char topic_096 [] = { "restore_nvram" };
char  text_096 [] = { "Restore NVRAM data to EEROM/TOY from a floppy file." };
char   syn_096 [] = { "restore_nvram {all,arc,srm,toy} " };
