...
#define MAX_MEMORY_ARRAY 3
#define MAX_MEMORY_CHUNK 1
#define MAX_PHYSMEM_MB 0
#define MAX_PROCESSOR_ID 1
...
#define SYSTEM_TYPE 201

/*
 * Strings:
 */
#define OPTIONS_FW_FILE "up1000fw"
