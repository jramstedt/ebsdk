...
extern jtopal ();
extern show_ide ();
extern clear_bad_driver ();
extern pci_registers ();
extern info ();
extern dynamic ();
extern alloc_cmd ();
extern free_cmd ();
...
extern nettest ();
extern lfu ();
extern init_system_monitor ();
extern M1543cDisplayDeviceInfo ();
extern ewrk3_config ();
extern wwidmgr ();
extern mc_diag ();
extern pcimc_cable ();
struct {
	...
	{"show_ide",        show_ide,        R|X|B|Z, 0},
	{"clear_bad_driver",clear_bad_driver,R|X|B|Z, 0},
	{"pci_registers",   pci_registers,   R|X|B|Z, 0},
	{"info",            info,            R|X|B|Z, 0},
	...
	{"lfu",             lfu,             R|X|B, 0},
	{"init_system_monitor",init_system_monitor,R|X|B|Z, 0},
	{"southbridge_info",M1543cDisplayDeviceInfo,R|X|B|Z, 0},
