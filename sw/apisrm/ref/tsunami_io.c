...
outportb( struct pb *pb, unsigned quad offset, unsigned byte data )
    {
    xportx( pb, offset, data, stb );
    }

outportw( struct pb *pb, unsigned quad offset, unsigned word data )
    {
    xportx( pb, offset, data, stw );
    }

outportl( struct pb *pb, unsigned quad offset, unsigned long data )
    {
...
outmemb( struct pb *pb, unsigned quad offset, unsigned byte data )
    {
    xmemx( pb, offset, data, stb );
    }

outmemw( struct pb *pb, unsigned quad offset, unsigned word data )
    {
    xmemx( pb, offset, data, stw );
    }

outmeml( struct pb *pb, unsigned quad offset, unsigned long data )
    {
    xmemx( pb, offset, data, stl );
    }

outmemq( struct pb *pb, unsigned quad offset, unsigned quad data )
    {
...
outdmeml( struct pb *pb, unsigned quad offset, unsigned long data )
    {
    outmeml( pb, offset, data );
    }

outdmemq( struct pb *pb, unsigned quad offset, unsigned quad data )
    {
...
outcfgb( struct pb *pb, unsigned quad offset, unsigned byte data )
    {
    xcfgx( pb, offset, data, stb );
    }

outcfgw( struct pb *pb, unsigned quad offset, unsigned word data )
    {
    xcfgx( pb, offset, data, stw );
    }

outcfgl( struct pb *pb, unsigned quad offset, unsigned long data )
    {
...
outtig( struct pb *pb, unsigned quad offset, unsigned byte data )
    {
...
read_pci_id_handler( unsigned int *flag, void *frame )
    {
...
read_pci_id( int hose, int bus, int slot, int function )
    {
    int flag;
    unsigned int id;
    struct HQE hqe;
