 ...
 */

/*$Header:   Y:/source/chimscsi/src/himscsi/hwmscsi/HWM.HV_   1.4.7.0   13 Nov 1997 18:08:04   MAKI1985  $*/
/***************************************************************************
*                                                                          *
...
#endif

/*$Header:   Y:/source/chimscsi/src/himscsi/hwmscsi/HWMREF.HV_   1.85.2.6   07 Apr 1998 20:50:20   THU  $*/
/***************************************************************************
*                                                                          *
...
#define  SCSI_hSCSISEQ_COPY(hhcb)    (hhcb)->SCSI_HP_firmwareDescriptor->ScsiSeqCopy
...
#if SCSI_TRIDENT_PROTO
#define  SCSI_hSCSISEQ_COPY(hhcb)            SCSI_S64_SCSISEQ_COPY
#endif /* SCSI_TRIDENT_PROTO */
...
#if SCSI_TRIDENT_PROTO
#define  SCSI_hSCSISEQ_COPY(hhcb)            SCSI_W64_SCSISEQ_COPY
#endif /* SCSI_TRIDENT_PROTO */
...
#if SCSI_TRIDENT_PROTO
#define  SCSI_hSCSISEQ_COPY(hhcb)            SCSI_W32_SCSISEQ_COPY
#endif /* SCSI_TRIDENT_PROTO */
...
#if SCSI_TRIDENT_PROTO
#define  SCSI_hSCSISEQ_COPY(hhcb)            SCSI_SADV_SCSISEQ_COPY
#endif /* SCSI_TRIDENT_PROTO */
...
#if SCSI_TRIDENT_PROTO
#define  SCSI_hSCSISEQ_COPY(hhcb)            SCSI_WADV_SCSISEQ_COPY
#endif /* SCSI_TRIDENT_PROTO */
...
void SCSIhInitiatePPR(SCSI_HHCB SCSI_HPTR,SCSI_HIOB SCSI_IPTR);
void SCSIhVerifyPPRResponse(SCSI_HHCB SCSI_HPTR,SCSI_HIOB SCSI_IPTR);
void SCSIhInitiateWide(SCSI_HHCB SCSI_HPTR,SCSI_HIOB SCSI_IPTR);
...
void SCSIhSendMessage(SCSI_HHCB SCSI_HPTR,SCSI_HIOB SCSI_IPTR,int);
int SCSIhReceiveMessage(SCSI_HHCB SCSI_HPTR,SCSI_HIOB SCSI_IPTR,int);
...
void SCSIhNsxRepeaterCommunication(SCSI_HHCB SCSI_HPTR,SCSI_HIOB SCSI_IPTR);
...
HIM_UEXACT8 SCSIhResetScsi(SCSI_HHCB SCSI_HPTR);
...
void SCSIhWriteE2Register(SCSI_UINT16,SCSI_UINT16,SCSI_REGISTER,int);
...
#endif /* SCSI_LOOPBACK_OPERATION */

/*$Header:   Y:/source/chimscsi/src/himscsi/hwmscsi/HWMDEF.HV_   1.24.14.0   13 Nov 1997 18:08:26   MAKI1985  $*/
/***************************************************************************
*                                                                          *
* Copyright 1995,1996,1997,1998 Adaptec, Inc.,  All Rights Reserved.       *
*                                                                          *
