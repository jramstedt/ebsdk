...
void AppendHex(u_int value, int width, int negate); /* Append a hex string */
void AppendRad50(int nwords, U_INT_16 *words);	/* Append a rad50 string */
void AppendChar(char ch);			/* Append a character */
void AppendString(int length, char *string);	/* Append a string */
...
void AppendRad50(int nwords, U_INT_16 *words)
{
    int i, j;
    U_INT_16 number;
    u_char c[3];
