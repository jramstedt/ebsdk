...
#if 0
#include "chimhw.h"	/* exclude */
#include "chimosm.h"	/* exclude */
#include "chimcom.h"	/* exclude */
#include "chimscsi.h"	/* exclude */
#endif

...
#define SCSI_STANDARD64_MODE        0        /* enable standard 64 mode */
#define SCSI_STANDARD_ADVANCED_MODE 0        /* enable standard bayonet mode */
#define SCSI_SWAPPING_ADVANCED_MODE 1        /* enable swapping bayonet mode */
#define SCSI_STANDARD_160M_MODE     0        /* enable standard trident mode */
#define SCSI_SWAPPING_160M_MODE     0        /* enable swapping trident mode */
#define SCSI_DOWNSHIFT_MODE         0        /* enable down shift mode */
...
#include "scsihw.h"	/* exclude */
#include "scsiosd.h"	/* exclude */
#include "scsicom.h"	/* exclude */
#endif

...
#if defined(SCSI_DATA_DEFINE)
#if SCSI_STANDARD64_MODE
#include "cp$src:aic78xx_seq_s64.h"
#endif
#if SCSI_STANDARD32_MODE
#include "seq_s32.h"	/* exclude */
#endif
#if SCSI_SWAPPING64_MODE
#include "seq_w64.h"	/* exclude */
#endif
#if SCSI_SWAPPING32_MODE
#include "cp$src:aic78xx_seq_w32.h"
#endif
#if SCSI_STANDARD_ADVANCED_MODE
#include "seq_sadv.h"	/* exclude */
#endif
#if SCSI_SWAPPING_ADVANCED_MODE
#include "cp$src:aic78xx_seq_wadv.h"
#endif
#if SCSI_STANDARD_160M_MODE
#include "seqs160m.h"	/* exclude */
#endif
#if SCSI_SWAPPING_160M_MODE
#include "seqw160m.h"	/* exclude */
#endif
#if SCSI_DOWNSHIFT_MODE
#include "seq_dwn.h"	/* exclude */
#endif
#endif
...
struct SCSI_HW_INFORMATION_
{
   ...
   struct
   {
      SCSI_UEXACT16 maxTagScbs;              /* Max tagged scbs per target    */
