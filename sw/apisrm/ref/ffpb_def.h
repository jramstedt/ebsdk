 ...
 *
 *
 * Abstract:	Future Bus FDDI port block Definitions
 *
 ...
 * Modifications:
 *
 *	kcq	 5-Feb-1993	extracted from port specific definition.
 */
#if 1
...
/*    struct LOCK 	spl_port;	*/	/* Must be aligned on a quadword */
    ...
    struct SEMAPHORE 	ff_isr_s;		/* Semaphores for EZ interrupts*/
