...
/*
 *  $Id: local.h,v 1.1 1999/03/29 22:17:37 stig Exp $;
 */

/*
 * $Log: local.h,v $
 * Revision 1.1  1999/03/29 22:17:37  stig
 * Tools required for building the debug monitor/manufacturing diags added.
 * Build environment is Alpha-Linux
 *
