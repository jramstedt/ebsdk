/*
 *      VID: [T1.2] PT: [Fri May 23 16:54:48 1997] SF: [osf.h]
 *       TI: [/sae_share/apps/bin/vice -iplatform.s -l// -p# -DEB164 -h -m -aeb164 ]
 */
...
**
**  $Id: osf.h,v 1.3 2000/05/03 16:08:40 stig Exp $
**
**  MODIFICATION HISTORY:
**
**  $Log: osf.h,v $
**  Revision 1.3  2000/05/03 16:08:40  stig
**  support for SROM UART interrupt routing to OS/console
**
**  Revision 1.2  2000/04/11 23:33:10  stig
**  Release 1.3.3 source base
**
**  Revision 1.1  1999/06/30 20:37:55  stig
**  Reorganisation for common PALcode source for API platforms
**
**  Revision 1.1  1999/06/21 19:01:04  stig
**  reorganisation of PALcode structure
**
**  Revision 1.3  1999/03/19 20:32:59  stig
**  Nautilus OSF PALcode, latest edition...
**
**  Revision 1.1.1.1  1998/12/29 21:36:08  paradis
**  Initial CVS checkin
**
 * Revision 1.1  1997/10/21  13:54:18  samberg
 * Initial revision
 *
**  Revision 1.13  1996/06/17  15:51:02  fdh
**  Modified the STACK_FRAME macro definition to resolve
**  a register usage conflict by removing a case where the
**  register usage was hardwired into the macro.
**
**  Revision 1.12  1995/04/21  20:49:45  cruz
**  Changed some constants because ASAXP did not like the way
...
#define INT_K_SL	0x5		/* STIG: addition of SROM UART IO */
...
#define SCB_Q_SYS_EVENT		0x0680
#define SCB_Q_PASSREL		0x06F0
...
#define STACK_FRAME(tmp1,tmp2,tmp3)	\
	sll	ps, 63-PS_V_CM, tmp3;	\
	bge	tmp3, 0f;		\
	bis	zero, zero, ps;		\
	mtpr	sp, ptUsp;		\
	mfpr	sp, ptKsp;		\
...
#define MCHK_K_DC_TAG_PERR  0x009E
#define MCHK_K_ISTREAM_CMOV 0x00A0
#define MCHK_K_ISTREAM_CMOV_FAULT 0x00A2
...
#define MCHK_K_SYS_CORR_ECC 0x0204
#define MCHK_K_SYS_EVENT    0x0206
