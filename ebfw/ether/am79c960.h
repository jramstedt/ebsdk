...
/*
 * $Id: am79c960.h,v 1.1.1.1 1998/12/29 21:36:05 paradis Exp $
 */
 ...
 * Initial CVS checkin
 *
 * Revision 1.14  1996/08/07  17:54:37  fdh
 * Changed the dma channel assigned to the 0x320 base address.
 *
 * Revision 1.13  1996/05/28  14:44:47  fdh
 * Modified ISA resource definitions.
 *
 * Revision 1.12  1996/05/28  14:34:49  fdh
 * Modified ISA resource definitions.
 *
 * Revision 1.11  1996/05/26  19:59:04  fdh
 * Modified ISA definitions to use dma channel insted of
 * the dma mask.
 *
 * Revision 1.10  1996/05/22  21:41:11  fdh
 * Modified ISA resource definitions.
 *
 * Revision 1.9  1995/10/20  19:05:34  cruz
 * Moved prototype declarations to ether.h
 * ..
 *
...
/* Maximum number of AMD79C960's supported in the Debug monitor */
#define AM79C960_MAX_DEVICES	2


/*
 * AM79C960_BASEXXX_INTERRUPT defines the
 * interrupt used for a given base address.
 */
#ifndef AM79C960_BASE360_INTERRUPT
#define AM79C960_BASE360_INTERRUPT	9
#endif

#ifndef AM79C960_BASE340_INTERRUPT
#define AM79C960_BASE340_INTERRUPT	9
#endif

#ifndef AM79C960_BASE320_INTERRUPT
#define AM79C960_BASE320_INTERRUPT	9
#endif

#ifndef AM79C960_BASE300_INTERRUPT
#define AM79C960_BASE300_INTERRUPT	9
#endif


/*
 * AM79C960_BASEXXX_DMACHANNEL defines the
 * dma channel used for a given base address.
 */
#ifndef AM79C960_BASE360_DMACHANNEL
#define AM79C960_BASE360_DMACHANNEL	7
#endif

#ifndef AM79C960_BASE340_DMACHANNEL
#define AM79C960_BASE340_DMACHANNEL	6
#endif

#ifndef AM79C960_BASE320_DMACHANNEL
#define AM79C960_BASE320_DMACHANNEL	5
#endif

#ifndef AM79C960_BASE300_DMACHANNEL
#define AM79C960_BASE300_DMACHANNEL	5
#endif
