...
#ifndef LINT
__attribute__((unused)) static const char *rcsid = "$Id: romhead.c,v 1.3 1999/04/14 20:51:24 paradis Exp $";
#endif

/*
 * $Log: romhead.c,v $
 * Revision 1.3  1999/04/14 20:51:24  paradis
 * Added type 11 for server management console
 *
 * Revision 1.2  1999/02/03 16:14:22  gries
