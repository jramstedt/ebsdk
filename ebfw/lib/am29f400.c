...
#ifndef LINT
__attribute__((unused)) static const char *rcsid = "$Id: am29f400.c,v 1.1.1.1 1998/12/29 21:36:10 paradis Exp $";
#endif
 ...
 * Initial CVS checkin
 *
 * Revision 1.2  1997/05/02  20:20:09  fdh
 * Moved the prototype for the init function.
 *
 * Revision 1.1  1997/05/01  20:41:08  pbell
 * Initial revision
 *
 */
